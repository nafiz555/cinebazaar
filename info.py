...
auth_channel = environ.get('AUTH_CHANNEL', '-1001887421342') # give your force subscribe channel id here else leave it blank
...
CLONE_DATABASE_URI = environ.get('CLONE_DATABASE_URI', "mongodb+srv://cinebazaar:cinebazaar@cluster0.cuqhifm.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") # Necessary If clone mode is true
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/CineBaazar')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/CineBazaar')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_To_Open_Linkl')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'soulofdrama') # Support Chat Link Without https:// or @
