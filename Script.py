...
Hᴇʀᴇ Yᴏᴜ Cᴀɴ Rᴇϙᴜᴇꜱᴛ CɪɴᴇDʀᴀᴍᴀꜱ, Jᴜꜱᴛ Sᴇɴᴛ Mᴏᴠɪᴇ,Dʀᴀᴍᴀ OR WᴇʙSᴇʀɪᴇꜱ Nᴀᴍᴇ Wɪᴛʜ Pʀᴏᴘᴇʀ Gᴏᴏɢʟᴇ Sᴘᴇʟʟɪɴɢ..!!</b>"""
...
‣ ᴅᴇᴠᴇʟᴏᴘᴇʀ : <a href='https://t.me/Netflix_Dramas'>Netflix</a> 
...
ʀᴇғᴇʀᴀʟ ʟɪɴᴋ - https://telegram.me/{}?start=CineDrama-{}
...
<b>ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ:</b>
<code>[Button Text](buttonurl:https://t.me/CineDrama)</code>
<b>ᴀʟᴇʀᴛ ʙᴜᴛᴛᴏɴꜱ:</b>
...
Cᴏᴍᴍᴀɴᴅs Aɴᴅ Usᴀɢᴇ:
• /stats - <code>ᴛᴏ ɢᴇᴛ ꜱᴛᴀᴛᴜꜱ ᴏꜰ ꜰɪʟᴇꜱ ɪɴ ᴅʙ.
...
ஏய் <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 படி 1: இந்த CineDramaBot போட் உங்கள் குழுவை நிர்வாகியாக்குங்கள்
...
Hey <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 Step 1: Administer this CineDramaBot to your group
...
హే <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 దశ 1: ఈ CineDramaBOT బాట్‌ని మీ సమూహానికి నిర్వహించండి
...
अरे <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 चरण 1: इस CineDrama बॉट को अपने समूह में प्रशासित करें
...
ഹേയ് <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 ഘട്ടം 1: ഈ CineDramaBot ബോട്ട് നിങ്ങളുടെ ഗ്രൂപ്പിലേക്ക് നൽകുക
...
നിങ്ങളുടെ ടീം വീഡിയോ ശേഖരണവും പരിശീലിപ്പിക്കും..."""
 ...
 مرحلہ 1: اپنے گروپ میں اس CineDramaBot بوٹ کا انتظام کریں۔
...
અરે <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 પગલું 1: તમારા જૂથમાં આ CineDramaBot બોટનું સંચાલન કરો
...
আরে <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 ধাপ 1: আপনার গ্রুপে এই CineDramaBot বট পরিচালনা করুন
...
এছাড়াও আপনার দল ভিডিও সংগ্রহের প্রশিক্ষণ দেবে..."""
    ...
    DEVELOPER_TXT = """
special Thanks To ❤️ CineDrama -

-Dev 1 [Owner of this bot ]<a href='https://t.me/CineDrama'>CineDrama</a>

-Dev 2 <a href='https://t.me/Netflix_Dramas'>Netflix</a>

-Dev 3 <a href='https://t.me/CineBazaar'>CineBazaar</a>

- Dev 4 <a href='https://t.me/CineBazaarBot'>TEAM CineDrama</a>
"""
